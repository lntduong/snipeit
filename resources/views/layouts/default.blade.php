                   ...
                   @can('create', \App\Models\Score::class)
                     ...
                     @can('create', \App\Models\Asset::class)
                      <li {!! (Request::is('hardware/create') ? 'class="active>"' : '') !!}>
                       ...
                       <li {!! (Request::is('licenses/create') ? 'class="active"' : '') !!}  id="hideLicenseCreate">
                       ...
                       <li {!! (Request::is('accessories/create') ? 'class="active"' : '') !!}  id="hideAccessoriesCreate">
                       ...
                       <li {!! (Request::is('consunmables/create') ? 'class="active"' : '') !!}  id="hideConsumableCreate">
                       ...
                       <li {!! (Request::is('components/create') ? 'class="active"' : '') !!}  id="hideComponentsCreate">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview{{ (Request::is('hardware*') ? ' active' : '') }}">
              ...
              @endcan
              @can('view', \App\Models\License::class)
              <li{!! (Request::is('licenses*') ? ' class="active"' : '') !!}  id="hideLicenses">
                  <a href="{{ route('licenses.index') }}">
                    <i class="fa fa-floppy-o"></i>
              ...
              @endcan
              @can('index', \App\Models\Accessory::class)
              <li{!! (Request::is('accessories*') ? ' class="active"' : '') !!}  id="hideAccessories">
                <a href="{{ route('accessories.index') }}">
                  <i class="fa fa-keyboard-o"></i>
            ...
            <li{!! (Request::is('consumables*') ? ' class="active"' : '') !!}  id="hideConsumable">
                <a href="{{ url('consumables') }}">
                  <i class="fa fa-tint"></i>
             ...
             @endcan
             @can('view', \App\Models\Component::class)
            <li{!! (Request::is('components*') ? ' class="active"' : '') !!}  id="hideComponents">
                <a href="{{ route('components.index') }}">
                  <i class="fa fa-hdd-o"></i>
            ...
            @endcan
            @can('import')
                <li{!! (Request::is('import/*') ? ' class="active"' : '') !!}  id="hideImport">
